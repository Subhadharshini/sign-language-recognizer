# -*- coding: utf-8 -*-
"""
Created on Fri Sep 25 16:35:41 2020
...
classifier = load_model('TrainedModel.h5')			
            
# Main predictor function that uses the loaded model
def predictor():
	import numpy as np
...
class Dashboard(QtWidgets.QMainWindow):
	...
	def createGest(self):
		...
		try:
			...
			pass
		self.exit_button.clicked.connect(self.quitApplication)
		self.plainTextEdit.setPlaceholderText("Enter custom gesture name") 
		img_text = ''
		saveimg=[]
		while True:
    ...
    #Stream of characters detection
	def scanSent(self):
		try:
			clearfunc(self.cam)
		except:
...
#custom gesture images are saved
